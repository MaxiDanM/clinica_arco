    ...
    <div class="footer__grid">
        <div class="footer__contenido">
            ...
            <p class="footer__texto">
                Descubre la tranquilidad de cuidado médico de alta calidad en un ambiente acogedor y moderno. Tu bienestar es nuestra misión en Clínica Arco: donde la salud encuentra su hogar.
            </p>
        </div>
